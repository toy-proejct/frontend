...
const CraftMap: NextPage = () => {
    ...
    useEffect(() => {
     ...
     useEffect(() => {
        shopList?.map((shop) => {markerRef.current = new naver.maps.Marker({
      ...
      function markerClickEvent(marker: any, item: any) {
        naver.maps.Event.addListener(marker, 'click', (e: any) => {
          ...
          if (!selectedMarker.current ||(selectedMarker.current !== marker && item.name !== undefined)){
